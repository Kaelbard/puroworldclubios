...
class QuorumTorpedoWidget extends StatefulWidget {
  const QuorumTorpedoWidget({Key key}) : super(key: key);

  @override
  _QuorumTorpedoWidgetState createState() => _QuorumTorpedoWidgetState();
}

class _QuorumTorpedoWidgetState extends State<QuorumTorpedoWidget> {
          ...
          children: [
            ...
            Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  await launchURL('https://buy.stripe.com/6oE14tg0U0WT8YUdRf');
                },
                text: 'R\$ 825,00 + Frete',
