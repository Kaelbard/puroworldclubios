...
class DonDiegoEuroMonarchTubeWidget extends StatefulWidget {
  const DonDiegoEuroMonarchTubeWidget({Key key}) : super(key: key);

  @override
  _DonDiegoEuroMonarchTubeWidgetState createState() =>
      _DonDiegoEuroMonarchTubeWidgetState();
}

class _DonDiegoEuroMonarchTubeWidgetState
    extends State<DonDiegoEuroMonarchTubeWidget> {
          ...
          children: [
            ...
            Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  await launchURL('https://buy.stripe.com/aEU5kJ9Cw5d9ejecN3');
                },
                text: 'R\$ 996,60 + Frete',
