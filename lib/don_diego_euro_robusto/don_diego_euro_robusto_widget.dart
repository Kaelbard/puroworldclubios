...
class DonDiegoEuroRobustoWidget extends StatefulWidget {
  const DonDiegoEuroRobustoWidget({Key key}) : super(key: key);

  @override
  _DonDiegoEuroRobustoWidgetState createState() =>
      _DonDiegoEuroRobustoWidgetState();
}

class _DonDiegoEuroRobustoWidgetState extends State<DonDiegoEuroRobustoWidget> {
