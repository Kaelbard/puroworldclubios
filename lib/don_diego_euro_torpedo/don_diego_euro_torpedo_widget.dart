...
class DonDiegoEuroTorpedoWidget extends StatefulWidget {
  const DonDiegoEuroTorpedoWidget({Key key}) : super(key: key);

  @override
  _DonDiegoEuroTorpedoWidgetState createState() =>
      _DonDiegoEuroTorpedoWidgetState();
}

class _DonDiegoEuroTorpedoWidgetState extends State<DonDiegoEuroTorpedoWidget> {
          ...
          children: [
            ...
            Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  await launchURL('https://buy.stripe.com/aEU3cB3e89tp1ws3cp');
                },
                text: 'R\$ 798,60 + Frete',
